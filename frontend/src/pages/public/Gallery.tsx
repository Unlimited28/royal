                ...
                {loading ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                        {filteredItems.map((item) => (
                            <Card key={item._id} className="overflow-hidden hover:-translate-y-1 transition-transform duration-300">
                                <div className="aspect-square bg-navy-800 flex items-center justify-center overflow-hidden">
                                    {item.imageUrl ? (
                        ...
                        {filteredItems.length === 0 && <p className="text-slate-500 italic text-center col-span-full">No items found.</p>}
                    </div>
                )}
            </section>
            ...
            <section>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <Card className="p-6 text-center">
                        <div className="text-3xl font-bold text-gold-500 mb-2">{galleryItems.length}</div>
