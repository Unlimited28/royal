...
export const Register: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const fullname = (rawData.fullname as string) || '';
        ...
        const data: any = {
            ...
            lastName,
            phone: rawData.phone,
            church: rawData.church,
            associationName: rawData.association_id as string,
            age: parseInt(rawData.age as string),
            role: rawData.role as string,
            passcode: rawData.passcode as string,
        };
        ...
        try {
            ...
            const errorMessage = err.response?.data?.message || err.message || 'An unknown registration error occurred.';
