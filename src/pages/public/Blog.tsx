                            ...
                            <div>
                                <div className="flex items-center space-x-4 mb-4">
                                    ...
                                    <span className="text-slate-400 text-sm">
                                        {new Date(mockBlogPosts[0].created_at).toLocaleDateString('en-US', {
                                            year: 'numeric',
                                            month: 'long',
                                            day: 'numeric'
                                        })}
                                ...
                                <h3 className="text-2xl font-bold text-white mb-4">{mockBlogPosts[0].title}</h3>
                                <p className="text-slate-400 mb-6 leading-relaxed">{mockBlogPosts[0].excerpt}</p>
                                <Link to={`/blog/${mockBlogPosts[0].id}`}>
